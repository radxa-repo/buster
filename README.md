[View on GitHub](https://github.com/radxa-repo/buster)
...
sudo tee /etc/apt/sources.list.d/radxa.list <<< "deb [signed-by=/usr/share/keyrings/radxa-archive-keyring.gpg] https://radxa-repo.github.io/buster/ $VERSION_CODENAME main"
sudo apt update
```
